...
public class Path
{
	...
	public void MovePoint(int i, Vector2 pos)
	{
		...
		if (i % 3 == 0) {
			...
			if (correspondingCtrlIndex >= 0 && correspondingCtrlIndex < points.Count) {
				float dist = (points [anchorIndex] - points [correspondingCtrlIndex]).magnitude;
				Vector2 dir = (points [anchorIndex] - pos).normalized;
				points [correspondingCtrlIndex] = points [anchorIndex] + dir * dist;
			}
		}
